...
__all__ = ["Config", "DatasetHandler", "ModelUtils", "HeadImportanceMeasurer", "GeneticPruningOptimizer"]

# Import sub-modules (they expect Config to exist)

@dataclass
class Config:
    # default hyper-parameters (same as old config.py)
...
# re-export existing submodules (imports remain the same)
from .dataset_handler import DatasetHandler
from .model_utils import ModelUtils
from .head_importance import HeadImportanceMeasurer
from .genetic_pruning import GeneticPruningOptimizer
